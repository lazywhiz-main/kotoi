...
-- ============================================================
-- Grants: authenticated ロールに Data API アクセスを付与
-- ============================================================
grant usage on schema public to authenticated;
grant select, insert, update, delete on notes to authenticated;
grant select, insert, update, delete on thread_items to authenticated;
grant select, insert, update, delete on explorations to authenticated;
grant select, insert, update, delete on exploration_notes to authenticated;
grant select, insert, update, delete on exploration_questions to authenticated;
grant select, insert, update, delete on tags to authenticated;
grant select, insert, update, delete on note_tags to authenticated;
grant select, insert on usage_ledger to authenticated;
grant select, insert on classification_feedback to authenticated;
grant select on open_questions to authenticated;
