...
> 価格の根拠は `../pricing_参照価格_v0.2.md`、収支は `../MONDO_PL_model_v2.xlsx` を参照。
>
...
一般的なアプリは「14日たったので払ってください」と言う。MONDOはそれをやらない。

**MONDOは「価値が出た瞬間」に課金する。**

原価分析でも判明している通り、MONDOの価値はPhase A（最初の2〜4週）には出ない。メモが溜まり、束になり、探究が立ち上がって、**見取り図が1枚できたとき**に初めて「これは他にない」と分かる。

だから期間ではなく**到達**で切る。ただし訊くタイミングは「見せた直後」ではなく、**もっと欲しくなったとき**。

> **1枚目の見取り図は、そのまま渡す。**  
> （見る・保存する・あとで SNS に投稿する——ここまで無料）  
> **2枚目を作ろうとしたとき**に、「続きは、MONDOと一緒に。」
...
|---|---|---|
| **一般・月払い** | **¥1,800 / 月** | |
| **一般・年払い** | **¥15,000 / 年**（月換算 ¥1,250） | **推奨として提示**（デフォルト選択） |
| **学割・月払い** | ¥900 / 月 | |
| **学割・年払い** | ¥7,500 / 年 | |
...
- 残量・使用量は**一切表示しない**。「無制限」で通す（ソフトキャップは¥1,800なら不要 — 最重量ユーザーでも黒字）
...
**ストアの商品ID**
```
mondo.pro.monthly          ¥1,800
mondo.pro.annual           ¥15,000
mondo.student.monthly      ¥900
mondo.student.annual       ¥7,500
```
...
- **使用量メーター・残量表示**（思想と衝突する。¥1,800なら原価的にも不要）
